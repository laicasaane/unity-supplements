...
namespace System.Collections.Generic
{
    public readonly partial struct Segment<T> : ISegment<T>, IEquatableReadOnlyStruct<Segment<T>>
    {
        ...
        {
            this.source = new Array1Source(source);
            this.HasSource = true;
            this.Offset = 0;
        ...
        internal ISegmentSource<T> GetSource()
            => this.HasSource ? (this.source ?? Array1Source.Empty) : Array1Source.Empty;

        public Segment(ISegmentSource<T> source)
        {
            this.source = source ?? Array1Source.Empty;
            this.HasSource = true;
            this.Offset = 0;
        ...
        public static Segment<T> Empty { get; } = new Segment<T>(Array1Source.Empty);
