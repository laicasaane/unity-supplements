...
namespace System.ValueDelegates
{
    public static partial class ValueAction
    {
        ...
        public static void Invoke<TAction, TClosure, T>(in TAction action, TClosure closure, in T arg)
            where TAction : struct, IActionArgIn<TClosure, T>
        {
            action.SetArguments(in arg);
            action.Invoke(closure);
        ...
        public static void Invoke<TAction, TClosure, T1, T2>(in TAction action, TClosure closure, in T1 arg1, in T2 arg2)
            where TAction : struct, IActionArgIn<TClosure, T1, T2>
        {
            action.SetArguments(in arg1, in arg2);
            action.Invoke(closure);
        ...
        public static void Invoke<TAction, TClosure, T1, T2, T3>(in TAction action, TClosure closure, in T1 arg1, in T2 arg2, in T3 arg3)
            where TAction : struct, IActionArgIn<TClosure, T1, T2, T3>
        {
            action.SetArguments(in arg1, in arg2, in arg3);
            action.Invoke(closure);
        ...
        public static void Invoke<TAction, TClosure, T1, T2, T3, T4>(in TAction action, TClosure closure, in T1 arg1, in T2 arg2, in T3 arg3, in T4 arg4)
            where TAction : struct, IActionArgIn<TClosure, T1, T2, T3, T4>
        {
            action.SetArguments(arg1, arg2, arg3, arg4);
            action.Invoke(closure);
        ...
        public static void Invoke<TAction, TClosure, T1, T2, T3, T4, T5>(in TAction action, TClosure closure, in T1 arg1, in T2 arg2, in T3 arg3, in T4 arg4, in T5 arg5)
            where TAction : struct, IActionArgIn<TClosure, T1, T2, T3, T4, T5>
        {
            action.SetArguments(in arg1, in arg2, in arg3, in arg4, in arg5);
            action.Invoke(closure);
