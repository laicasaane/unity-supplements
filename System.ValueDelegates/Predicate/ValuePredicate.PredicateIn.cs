...
namespace System.ValueDelegates
{
    public static partial class ValuePredicate
    {
        ...
        public static bool Invoke<TPredicate, TClosure, T>(in TPredicate predicate, in TClosure closure, in T arg)
            where TPredicate : struct, IPredicateInArgIn<TClosure, T>
        {
            predicate.SetArguments(in arg);
            return predicate.Invoke(in closure);
        ...
        public static bool Invoke<TPredicate, TClosure, T1, T2>(in TPredicate predicate, in TClosure closure, in T1 arg1, in T2 arg2)
            where TPredicate : struct, IPredicateInArgIn<TClosure, T1, T2>
        {
            predicate.SetArguments(in arg1, in arg2);
            return predicate.Invoke(in closure);
        ...
        public static bool Invoke<TPredicate, TClosure, T1, T2, T3>(in TPredicate predicate, in TClosure closure, in T1 arg1, in T2 arg2, in T3 arg3)
            where TPredicate : struct, IPredicateInArgIn<TClosure, T1, T2, T3>
        {
            predicate.SetArguments(in arg1, in arg2, in arg3);
            return predicate.Invoke(in closure);
        ...
        public static bool Invoke<TPredicate, TClosure, T1, T2, T3, T4>(in TPredicate predicate, in TClosure closure, in T1 arg1, in T2 arg2, in T3 arg3, in T4 arg4)
            where TPredicate : struct, IPredicateInArgIn<TClosure, T1, T2, T3, T4>
        {
            predicate.SetArguments(in arg1, in arg2, in arg3, in arg4);
            return predicate.Invoke(in closure);
        ...
        public static bool Invoke<TPredicate, TClosure, T1, T2, T3, T4, T5>(in TPredicate predicate, in TClosure closure, in T1 arg1, in T2 arg2, in T3 arg3, in T4 arg4, in T5 arg5)
            where TPredicate : struct, IPredicateInArgIn<TClosure, T1, T2, T3, T4, T5>
        {
            predicate.SetArguments(in arg1, in arg2, in arg3, in arg4, in arg5);
            return predicate.Invoke(in closure);
